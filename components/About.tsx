...
export default function About() {
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mt-4 max-w-3xl mx-auto text-lg">
            Perth&apos;s trusted name in professional cleaning services. Serving residential and commercial clients 
            across Western Australia with excellence since 2015.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-white dark:bg-zinc-800 p-6 rounded-xl shadow-md border-l-4 border-green-500">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              Phone: 08 9000 0000<br />
              Mobile: 0405 866 459<br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                Founded in West Leederville, AASTACLEAN has grown to become one of Perth&apos;s most trusted 
                cleaning service providers. Our commitment to quality, reliability, and customer satisfaction 
                has made us the preferred choice for both residential and commercial cleaning across the region.
              </p>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mt-4">
                We understand that every space is unique. Whether you need a thorough end-of-lease clean 
                for your rental property, regular commercial cleaning for your office, or a one-off deep 
                clean for your home, our team delivers exceptional results every time.
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {certifications.map((cert) => (
                  <div key={cert.name} className="flex items-center gap-2 bg-zinc-100 dark:bg-zinc-700 p-3 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {serviceAreas.map((area) => (
                  <span key={area} className="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-200 rounded-full text-sm">
                    {area}
                  </span>
                ))}
              </div>
            ...
            <div className="space-y-6">
              {teamMembers.map((member) => (
                <div key={member.name} className="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-md">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {member.specialties.map((specialty) => (
                          <span key={specialty} className="px-2 py-1 bg-zinc-100 dark:bg-zinc-700 text-zinc-600 dark:text-zinc-300 rounded text-xs">
                            {specialty}
                          </span>
                        ))}
                      </div>
