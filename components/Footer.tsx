        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-slate-400 mb-4">
              ...
              Residential, commercial & end-of-lease cleaning with 100% satisfaction guarantee.
            </p>
            <div className="flex gap-4">
              <a href="https://www.facebook.com/aastaclean" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-sky-600 transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/aastaclean" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-sky-600 transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <span>📞</span>
                <a href="tel:0890000000" className="hover:text-sky-400 transition-colors">08 9000 0000</a>
              </li>
              <li className="flex items-center gap-2">
                <span>📱</span>
                <a href="tel:0405866459" className="hover:text-sky-400 transition-colors">0405 866 459</a>
              </li>
              <li className="flex items-center gap-2">
                <span>📧</span>
                <a href="mailto:aastaclean@gmail.com" className="hover:text-sky-400 transition-colors">aastaclean@gmail.com</a>
              </li>
              <li className="flex items-start gap-2">
                <span>📍</span>
                <span>51 Tate Street<br/>West Leederville 6007<br/>Perth, WA</span>
              </li>
            </ul>
          </div>
        </div>
