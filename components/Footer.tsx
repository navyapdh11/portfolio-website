		...
		<footer className="bg-slate-900 text-slate-300 py-16">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
					<div className="md:col-span-1">
						...
						<p className="text-sm text-slate-300 mb-4">
							Professional cleaning services in Perth, Western Australia. Residential, commercial &
							end-of-lease cleaning with 100% satisfaction guarantee.
						</p>
					...
					<div>
						...
						<ul className="space-y-3 text-sm">
							<li>
								<Link
									href="/services/domestic-cleaning/wa/perth"
							...
							<li>
								<Link
									href="/services/end-of-lease-cleaning/wa/perth"
									className="hover:text-sky-400 transition-colors"
								>
									End of Lease
								</Link>
							...
							<li>
								<Link
									href="/services/commercial-cleaning/wa/perth"
									className="hover:text-sky-400 transition-colors"
								>
									Commercial
								</Link>
							...
							<li>
								<Link
									href="/services/carpet-cleaning/wa/perth"
									className="hover:text-sky-400 transition-colors"
								>
									Carpet
								</Link>
							...
							<li>
								<Link
									href="/services/window-cleaning/wa/perth"
									className="hover:text-sky-400 transition-colors"
								>
									Window
								</Link>
							...
							<li>
								<Link
									href="/services/deep-cleaning/wa/perth"
									className="hover:text-sky-400 transition-colors"
								>
									Deep
								</Link>
					...
					<div>
						...
						<ul className="space-y-3 text-sm">
							...
							<li>
								<Link href="/ads" className="hover:text-sky-400 transition-colors">
									Ads Manager
								</Link>
							</li>
							<li>
								<Link href="/earn" className="hover:text-sky-400 transition-colors">
									Earnings
								</Link>
							</li>
							<li>
								<Link href="/flashcards" className="hover:text-sky-400 transition-colors">
									Strategy Cards
								</Link>
							</li>
							<li>
								<Link href="/microtasks" className="hover:text-sky-400 transition-colors">
									Microtasks
								</Link>
							</li>
						</ul>
					...
					<div>
						...
						<ul className="space-y-3 text-sm">
							<li className="flex items-center gap-2">
								<span>📞</span>
								<a href="tel:1300253268" className="hover:text-sky-400 transition-colors">
									1300 CLEAN
								</a>
							</li>
							<li className="flex items-center gap-2">
								<span>📱</span>
								<a href="tel:0405866459" className="hover:text-sky-400 transition-colors">
									0405 866 459
								</a>
							</li>
							<li className="flex items-center gap-2">
				...
				<div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
					<p className="text-sm">© 2026 AASTACLEAN. All rights reserved.</p>
