		...
		>
			<div className="mb-8">
				...
				<p className="text-zinc-600 text-sm">
					Choose how you&apos;d like to pay. No upfront payment required.
				</p>
			</div>
			...
			<div className="space-y-4">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					...
					>
						...
						<p className="text-sm text-zinc-500">
							Pay after the job is done. Cash, card, or transfer.
						</p>
					</button>
					<button
					...
					>
						...
						<p className="text-sm text-zinc-500">
							Receive an invoice via email. Pay within 7 days.
						</p>
					</button>
				</div>
				...
				>
					Confirm Booking — Pay{" "}
					{paymentMethod === "pay-on-service" ? "After Service" : "Via Invoice"}
				</button>
			</div>
		</section>
	);
