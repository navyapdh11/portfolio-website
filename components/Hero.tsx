		...
		>
			...
			<div
				...
				style={{
					...
					transition:
						"right 1s cubic-bezier(0.22, 1, 0.36, 1), bottom 1s cubic-bezier(0.22, 1, 0.36, 1)",
				}}
			/>
			<div
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 relative z-10">
				...
				<div className="flex justify-center mb-8 animate-fade-in">
					<div className="glass-strong inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/20">
						...
						<span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
							Australia&apos;s Premier Cleaning Network —{" "}
							<span className="text-sky-600">Nationwide Coverage</span>
						</span>
					</div>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
					...
					<div className="text-center lg:text-left">
						...
						{/* Social Proof */}
						<div
							className="flex items-center gap-3 mb-8 animate-fade-in stagger-2"
						...
						{/* CTA Buttons */}
						<div
							className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 animate-fade-in stagger-3"
						...
						{/* Trust Badges Row */}
						<div
							className="flex flex-wrap gap-4 justify-center lg:justify-start animate-fade-in stagger-4"
						...
						>
							{[
								...
								<div
									key={i}
									className="flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-subtle text-sm text-slate-300"
								>
									<svg
					...
					<div
						className="lg:w-full animate-scale-in stagger-4"
				...
				{/* All States Ticker */}
				<div
					className="mt-12 glass-subtle rounded-2xl px-6 py-4 border border-white/15 animate-fade-in"
					style={{ animationDelay: "0.8s", opacity: 0 }}
				>
					<p className="text-xs text-slate-400 uppercase tracking-wider font-semibold mb-3 text-center">
