      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <div className="relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 rounded-2xl h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="absolute top-4 left-4 px-4 py-2 bg-red-500 text-white rounded-lg font-bold">BEFORE</div>
            </div>
          </div>
          <div className="relative bg-gradient-to-br from-sky-100 to-cyan-100 dark:from-sky-900/30 dark:to-cyan-900/30 rounded-2xl h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="absolute top-4 left-4 px-4 py-2 bg-emerald-500 text-white rounded-lg font-bold">AFTER</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{active.service}</h3>
            ...
            <a href="#booking" className="px-6 py-3 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors font-semibold whitespace-nowrap">
              Get Similar Results
            </a>
          </div>
        </div>
