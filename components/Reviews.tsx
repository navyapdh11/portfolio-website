      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-8 inline-flex items-center gap-4 bg-zinc-50 dark:bg-zinc-800 px-8 py-4 rounded-full">
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-zinc-900 dark:text-white">Based on 2,847 reviews</p>
              <p className="text-xs text-zinc-600 dark:text-zinc-400">Across all states</p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
                      className={`w-5 h-5 ${i < review.rating ? "text-yellow-400" : "text-zinc-300 dark:text-zinc-600"}`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
        ...
        <div className="mt-12 flex flex-wrap justify-center items-center gap-8 opacity-60">
          <div className="text-center">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Happy Customers</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Would Recommend</p>
          </div>
        </div>
      </div>
    </section>
