			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					...
					<p className="text-zinc-600 dark:text-zinc-400 mt-4 max-w-2xl mx-auto">
						Ready to book a cleaning service? Get in touch with us today for a
						free quote!
					</p>
				</div>
					...
					<div className="space-y-8">
						<div>
							...
							<p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
								Professional cleaning services in Perth, Western Australia. We
								pride ourselves on delivering exceptional cleaning results every
								time. Contact us for a free quote!
							</p>
						</div>
							...
							<div className="flex items-center gap-4 p-4 bg-white dark:bg-zinc-900 rounded-lg shadow">
								...
								<div>
									...
									<a
										...
										className="text-zinc-900 dark:text-white font-medium hover:text-sky-600 transition-colors"
									>
