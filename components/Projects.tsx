...
const initialProjects: Project[] = [
	{
		...
		description:
			"A full-featured e-commerce platform with Next.js, Stripe integration, and admin dashboard.",
		tags: ["Next.js", "TypeScript", "Stripe"],
		image: "🛒",
		github: "https://github.com/navyapdh11",
		live: "https://portfolio-website-perth-tea.vercel.app",
		category: "fullstack",
	},
	{
		id: 2,
	...
	},
	{
		...
		title: "Blog CMS",
		description:
			"Content management system with markdown editor, SEO optimization, and media library.",
		tags: ["Next.js", "Sanity"],
		image: "✍️",
		github: "https://github.com/navyapdh11",
		live: "https://portfolio-website-perth-tea.vercel.app",
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				{isAdmin && (
					<div className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-2xl mb-12 border border-zinc-300 dark:border-zinc-700">
						<h3 className="font-bold text-lg mb-4 text-zinc-900 dark:text-white">
							Admin Control: Project Flashcards
						</h3>
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
							{projects.map((p) => (
								<div
									key={p.id}
									className="bg-white dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm"
								>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{filteredProjects.map((project) => (
						<div
							key={project.id}
							className="bg-zinc-50 dark:bg-zinc-800 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl hover-lift"
						>
							...
							<div className="p-6">
								...
								<div className="flex gap-3 mt-auto pt-4 border-t border-zinc-200 dark:border-zinc-700">
									<a
										...
										className="flex-1 px-4 py-2 bg-zinc-900 dark:bg-zinc-700 text-white rounded-lg text-center text-sm font-medium hover:bg-zinc-800"
									>
										Code
									</a>
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										className="flex-1 px-4 py-2 bg-blue-500 text-white rounded-lg text-center text-sm font-medium hover:bg-blue-600"
									>
										Live Demo
									</a>
								</div>
