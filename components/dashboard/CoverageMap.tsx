...
export function CoverageMap({ state, services, searchQuery, onSuburbClick }: CoverageMapProps) {
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-xl p-8 shadow-xl border">
      ...
      <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        <p className="text-sm text-blue-700 dark:text-blue-400">
          <strong>Interactive Map:</strong> Click on hotspots to filter suburbs by location.
          In production, this integrates with Leaflet or Google Maps for full interactivity.
        </p>
      </div>
    </div>
  );
