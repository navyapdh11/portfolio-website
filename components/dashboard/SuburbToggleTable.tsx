...
const sampleSuburbs: Suburb[] = [
  { id: "1", name: "Bondi Junction", postcode: "2022", state: "NSW", active: true, services: ["house-cleaning", "end-of-lease"], lastBooking: "2h ago", monthlyRevenue: 45000 },
  { id: "2", name: "Parramatta", postcode: "2150", state: "NSW", active: true, services: ["house-cleaning", "commercial"], lastBooking: "5h ago", monthlyRevenue: 38000 },
  { id: "3", name: "Manly", postcode: "2095", state: "NSW", active: false, services: [], lastBooking: "3d ago", monthlyRevenue: 0 },
  { id: "4", name: "Melbourne CBD", postcode: "3000", state: "VIC", active: true, services: ["house-cleaning", "end-of-lease", "commercial"], lastBooking: "1h ago", monthlyRevenue: 62000 },
  { id: "5", name: "South Yarra", postcode: "3141", state: "VIC", active: true, services: ["house-cleaning"], lastBooking: "4h ago", monthlyRevenue: 28000 },
  { id: "6", name: "Fortitude Valley", postcode: "4006", state: "QLD", active: true, services: ["house-cleaning", "commercial"], lastBooking: "3h ago", monthlyRevenue: 32000 },
  { id: "7", name: "Fremantle", postcode: "6160", state: "WA", active: false, services: [], lastBooking: "1w ago", monthlyRevenue: 0 },
  { id: "8", name: "North Adelaide", postcode: "5006", state: "SA", active: true, services: ["house-cleaning", "end-of-lease"], lastBooking: "6h ago", monthlyRevenue: 21000 },
  { id: "9", name: "Hobart CBD", postcode: "7000", state: "TAS", active: true, services: ["house-cleaning"], lastBooking: "8h ago", monthlyRevenue: 15000 },
  { id: "10", name: "Braddon", postcode: "2612", state: "ACT", active: true, services: ["house-cleaning", "commercial"], lastBooking: "2h ago", monthlyRevenue: 24000 },
];
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-xl border overflow-hidden">
      ...
      <div className="p-6 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          Showing <strong>{filteredSuburbs.length}</strong> of <strong>{sampleSuburbs.length}</strong>{" "}
          suburbs
        </p>
