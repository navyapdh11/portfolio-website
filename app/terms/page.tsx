		...
		<main className="min-h-screen bg-white dark:bg-slate-900 pt-24 pb-16">
			<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="prose dark:prose-invert max-w-none">
					...
					<p>
						You may cancel your booking up to 24 hours before the scheduled service time without
						penalty. Cancellations within 24 hours may incur a fee.
					</p>
					<h2>3. Satisfaction Guarantee</h2>
					<p>
						If you are not satisfied with our service, please contact us within 24 hours and we will
						return to reclean the problematic areas at no additional cost.
					</p>
				</div>
				<div className="mt-12">
