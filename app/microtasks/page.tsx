...
export const metadata: Metadata = {
	...
	description:
		"AASTACLEAN AI Microtasks - Earn $0.10-$2.00 per task training cleaning AI models. Uber-style microtasks for cleaners. View available tasks, heatmap, job offers, and earnings.",
	keywords:
		"AI microtasks, earn money, cleaning jobs, gig economy, AI training, data labeling, cleaning AI",
