...
export default function EarnContent() {
  ...
  const earnings: EarningEntry[] = [
    ...
    { id: 2, date: "2026-04-09", job: "Office Tower - Weekly", amount: 450, status: "completed" },
    { id: 3, date: "2026-04-08", job: "End of Lease - Subiaco", amount: 120, status: "completed" },
    { id: 4, date: "2026-04-07", job: "Medical Centre - Daily", amount: 95, status: "completed" },
    { id: 5, date: "2026-04-06", job: "Regular House Clean", amount: 75, status: "completed" },
    { id: 6, date: "2026-04-05", job: "Retail Space - Daily", amount: 75, status: "completed" },
    { id: 7, date: "2026-04-04", job: "Post-Reno Clean", amount: 200, status: "completed" },
    { id: 8, date: "2026-04-03", job: "Carpet Cleaning", amount: 60, status: "completed" },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-md">
            ...
            <p className="text-xs text-green-500 mt-1">↑ {((stats.thisMonth - stats.lastMonth) / stats.lastMonth * 100).toFixed(0)}% from last month</p>
          </div>
          <div className="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-md">
          ...
          <div className="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-md">
            ...
            <p className="text-3xl font-bold text-indigo-600">{formatCurrency(stats.averagePerJob)}</p>
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                    <h3 className="font-semibold text-zinc-900 dark:text-white mb-4">Monthly Earnings</h3>
                    <div className="h-40 flex items-end gap-2">
                      {[65, 78, 82, 70, 95, 88, 72, 90, 85, 92, 78, 98].map((val, i) => (
                        <div key={i} className="flex-1 bg-emerald-500 rounded-t" style={{ height: `${val}%` }}></div>
                      ))}
                    </div>
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                    <h3 className="font-semibold text-zinc-900 dark:text-white mb-4">Jobs by Type</h3>
                    <div className="space-y-3">
                      {[
                        { type: "Deep Clean", pct: 35, color: "bg-emerald-500" },
                        { type: "Commercial", pct: 28, color: "bg-blue-500" },
                        { type: "End of Lease", pct: 22, color: "bg-purple-500" },
            ...
            {activeTab === "history" && (
              <div className="space-y-3">
                {earnings.map((entry) => (
                  <div key={entry.id} className="flex justify-between items-center p-4 bg-zinc-50 dark:bg-zinc-700 rounded-xl">
                    <div>
            ...
            {activeTab === "payouts" && (
              <div className="space-y-4">
                ...
                <div className="p-4 border border-zinc-200 dark:border-zinc-700 rounded-xl">
                  <h3 className="font-semibold text-zinc-900 dark:text-white mb-3">Payout History</h3>
