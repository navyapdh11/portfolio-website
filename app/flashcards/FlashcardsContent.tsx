...
export default function FlashcardsContent() {
  ...
  const getPriorityColor = (priority: string) => {
    return priority === "high" ? "text-red-600" : priority === "medium" ? "text-amber-600" : "text-green-600";
  };
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold">{masteredCards.size}/{flashcards.length}</p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="p-5">
                ...
                <div className="min-h-[100px]">
                  {flippedCards.has(card.id) ? (
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 line-clamp-3">{card.front}</p>
                  )}
                </div>
        ...
        <div className="mt-12 p-6 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl">
          <h2 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">💡 Quick Action Checklist</h2>
