...
const quickContacts = [
	...
	{
		type: "Email",
		value: "aastaclean@gmail.com",
		href: "mailto:aastaclean@gmail.com",
		icon: "✉️",
	},
	{
		type: "Address",
		value: "51 Tate Street, West Leederville 6007",
...
const faqItems = [
	{
		...
		answer:
			"We typically respond within 2 hours during business hours. For urgent cleaning needs, call our mobile directly.",
	},
	{
		question: "Do you offer free quotes?",
		answer:
			"Yes! We provide free, no-obligation quotes for all our cleaning services. Use the form above or call us directly.",
	},
	{
		question: "What areas do you service?",
		answer:
			"We service the entire Perth metropolitan area including West Leederville, Subiaco, Nedlands, Claremont, and surrounding suburbs.",
	},
	{
		question: "What forms of payment do you accept?",
		answer:
			"We accept cash, bank transfer, and major credit cards. Invoice payments can be made via bank transfer.",
	},
];
			...
			<section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-blue-100 text-lg max-w-2xl mx-auto">
						Get in touch with AASTACLEAN for professional cleaning services
						across Perth WA. We&apos;re here to help with any questions or to
						book a service.
					</p>
				</div>
			</section>
						...
						<div className="space-y-8">
							<div>
								...
								<p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
									...
									or want to book a cleaning, we&apos;re here to help. Reach out
									through any of the methods below or fill out the form.
								</p>
							</div>
									...
									<div className="space-y-3">
										{businessHours.map((day) => (
											...
											>
												...
												<span
													className={`font-medium ${day.available ? "text-zinc-900 dark:text-white" : "text-zinc-400"}`}
												>
													{day.hours}
												</span>
											</div>
				...
				<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="space-y-4">
						{faqItems.map((item, index) => (
							<div
								key={index}
								className="bg-white dark:bg-zinc-900 rounded-lg shadow"
							>
								<button
									onClick={() =>
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						description:
							"Contact AASTACLEAN for professional cleaning services in Perth WA",
