						...
						<div className="space-y-8">
							<div>
								...
								<p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
									Whether you need a quote, have questions about our services, or want to book a
									cleaning, we&apos;re here to help. Reach out through any of the methods below or
									fill out the form.
								</p>
							</div>
			...
			<section className="py-16 bg-white dark:bg-zinc-900">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						<h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-4">Find Us</h2>
					...
					<div className="space-y-4">
						{faqItems.map((item, index) => (
							<div key={index} className="bg-white dark:bg-zinc-900 rounded-lg shadow">
								...
								{activeFaq === index && (
									<div className="px-6 pb-4 text-zinc-600 dark:text-zinc-400">{item.answer}</div>
								)}
							</div>
						))}
					</div>
