...
export const generateMetadata = async (): Promise<Metadata> => ({
  ...
  description: "Book your professional cleaning service online. Choose your service, schedule a date, and confirm your booking in minutes. Available across all Australian states.",
  alternates: {
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-white leading-[1.08] mb-6">
            Book Your
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-sky-400 animate-gradient" style={{ backgroundSize: "200% 200%" }}> Clean</span>
          </h1>

          <p className="text-lg md:text-xl text-slate-300/90 max-w-2xl mx-auto">
            Choose your service, pick a date, and confirm your booking in minutes. Bond-back guaranteed with police-checked professionals.
          </p>
        </div>
      </section>
