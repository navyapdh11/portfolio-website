    ...
    <main className="p-8 bg-slate-900 text-white min-h-screen">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
          ...
          <button className="w-full py-3 bg-sky-600 rounded-lg font-bold hover:bg-sky-500">Apply Strategy</button>
        </div>
        
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
          <h2 className="text-xl font-bold mb-4">Performance Metrics</h2>
          <div className="space-y-4">
             <div className="flex justify-between"><span>GEO-SEO Precision</span> <span>98.5/100</span></div>
             <div className="flex justify-between"><span>Voice AEO Score</span> <span>96.2/100</span></div>
             <div className="flex justify-between"><span>Link Health</span> <span>100%</span></div>
          </div>
        </div>
      </div>
    </main>
