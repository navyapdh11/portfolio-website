  ...
  return (
    <div className="space-y-6">
      <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
        <h2 className="text-2xl font-bold text-white mb-4">🧠 Strategy Flashcards</h2>
        <p className="text-slate-400 mb-6">
          SEO, CRO, GEO, AEO optimization recommendations and best practices for cleaning businesses.
        </p>
        <Link
          href="/flashcards"
      ...
      <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
        <h3 className="text-lg font-bold text-white mb-4">Latest Strategy Cards</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <div key={i} className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
              <span className="text-xs px-2 py-1 bg-amber-500/20 text-amber-400 rounded-full">{card.tag}</span>
