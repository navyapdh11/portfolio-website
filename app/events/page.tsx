	...
	const events = [
		{
			...
			description:
				"Join AASTACLEAN and the local community for a massive park clean-up followed by a cultural food festival and live music.",
			image:
		...
		},
		{
			...
			description:
				"Learn how to make your own eco-friendly cleaning products at home in this hands-on cultural workshop.",
			image:
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid md:grid-cols-2 gap-8">
					{events.map((event) => (
						<div
							key={event.id}
							className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow flex flex-col md:flex-row"
						>
