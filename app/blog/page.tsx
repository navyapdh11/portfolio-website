  ...
  const posts = [
    {
      ...
      excerpt: "Get your bond back guaranteed with our comprehensive end of lease cleaning checklist and professional tips.",
      date: "April 15, 2026",
    ...
    },
    {
      ...
      excerpt: "Discover the safe, non-toxic and environmentally friendly products our teams use to keep your home pristine.",
      date: "April 10, 2026",
      category: "Sustainability",
      image: "https://images.unsplash.com/photo-1584820927498-cafe8c1c9111?q=80&w=1000&auto=format&fit=crop"
    },
    {
      id: 3,
      title: "How Often Should You Deep Clean Your Office?",
      excerpt: "Maintain a healthy workspace and boost employee productivity with the right commercial cleaning schedule.",
      date: "April 5, 2026",
      category: "Commercial",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Stay up to date with the latest cleaning hacks, industry news, and updates from the AASTACLEAN team.
          </p>
        </div>
