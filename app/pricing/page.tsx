...
export const metadata: Metadata = {
	...
	description:
		"Upfront, competitive pricing for all cleaning services across Australia. No hidden fees. Bond-back guarantee included. Get an instant quote online.",
	alternates: { canonical: "https://www.aastaclean.com.au/pricing" },
	openGraph: {
		title: "Transparent Cleaning Prices — Nationwide | AASTACLEAN",
		description:
			"Upfront pricing for 20+ specialist cleaning services. No hidden fees. Book online in 2 minutes.",
		type: "website",
		locale: "en_AU",
		siteName: "AASTACLEAN",
	},
...
const pricingConfig: {
	...
	},
	{
		...
		base: 35,
		model: "per room",
		unit: "hot water extraction",
		freq: "Scotchgard from $25",
		popular: false,
	},
	{
	...
	},
	{
		...
		base: 75,
		model: "per oven",
		unit: "standard single",
		freq: "Food-safe products",
		popular: false,
	},
	{
	...
	},
	{
		...
		base: 30,
		model: "per load",
		unit: "wash + fold + deliver",
		freq: "Pickup & delivery",
		popular: false,
	},
	{
...
const croItems = [
	{
		icon: "🔥",
		text: "Book within 24 hours and receive a free interior window clean",
	},
	{ icon: "🛡️", text: "72-hour bond-back guarantee on all end of lease cleans" },
	{
		icon: "💳",
		text: "No upfront payment — pay after your clean is completed",
	},
...
export default function PricingPage() {
	return (
		<main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-24 pb-16 relative overflow-hidden">
			{/* Background blobs */}
			<div
				className="absolute top-20 -left-40 w-[500px] h-[500px] rounded-full opacity-20 blur-[120px] pointer-events-none"
				style={{
					background: "radial-gradient(circle, #0ea5e9 0%, transparent 70%)",
				}}
			/>
			<div
				className="absolute bottom-20 -right-40 w-[400px] h-[400px] rounded-full opacity-15 blur-[100px] pointer-events-none"
				style={{
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="text-center mb-16 animate-fade-in">
					...
					<h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 dark:text-white leading-tight mb-6">
						...
						<br />
						<span
							className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 via-cyan-500 to-sky-500"
							style={{
					...
					<p className="text-sm text-slate-500 dark:text-slate-400">
						...
						<span className="text-sky-500 font-medium">
							Final quote based on your property size &amp; scope.
						</span>
					</p>
				</div>
				...
				{/* CRO Banner */}
				<div
					className="glass p-6 rounded-3xl border border-white/20 mb-16 animate-fade-in"
					style={{ animationDelay: "0.3s", opacity: 0 }}
				>
					<h2 className="text-lg font-bold text-slate-900 dark:text-white mb-4 text-center">
						Why Customers Choose AASTACLEAN
					</h2>
									...
									<div className="mb-4 flex-1">
										...
										{details?.included && details.included.length > 4 && (
											<p className="text-xs text-slate-400 mt-2">
												+{details.included.length - 4} more inclusions
											</p>
										)}
									</div>
				...
				{/* Custom Quote CTA */}
				<div
					className="glass-strong rounded-3xl p-12 text-center border border-white/25 lightning-glow mb-16 animate-fade-in"
				...
				<div
					className="glass p-8 rounded-3xl border border-white/20 mb-16 animate-fade-in"
